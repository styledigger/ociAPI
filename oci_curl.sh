...
function oci-curl {
	# TODO: update these values to your own
		local tenancyId="ocid1.tenancy.oc1..aaaaaaaavoiuwqa6xpxpocrgny3jxh6r6rezzardnf73y54jsesorbsb2hja";
		local authUserId="ocid1.user.oc1..aaaaaaaa2wrnplozxpqx2rqrgrbk22lyqg7el5tvygrz4v3wl37aneaqvxpq";
		local keyFingerprint="d9:38:21:05:bb:e3:d5:3d:5a:c9:eb:b9:3e:d6:cd:e2";
		local privateKeyPath="/home/marian/oci_api/mkuna.pem";
...
curl -v "${extra_args[@]}" "${body_arg[@]}" -X $curl_method -sS https://${host}${escaped_target} "${curl_header_args[@]}" \
